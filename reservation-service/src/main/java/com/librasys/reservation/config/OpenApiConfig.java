...
public class OpenApiConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI()
                ...
                .info(new Info()
                        .title("LibraSys Reservation Service API")
                        .version("1.0.0")
                        .description("Microservice API for Book Reservation Queues & Fulfillment (Student 4)"))
                ...
                .components(new Components()
                        ...
                        .addSecuritySchemes("ApiKeyAuth", new SecurityScheme()
                                ...
                                .description("Enter direct API Key: 'reservation-service-key-2026'")));
    }
}
